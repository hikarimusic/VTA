...
# Usage
image_grid = [
    ['DEA_volcano_Cluster1_vs_Cluster2.png', 'DEA_heatmap_Cluster1_vs_Cluster2.png'],
    ['DEA_volcano_Cluster1_vs_Cluster3.png', 'DEA_heatmap_Cluster1_vs_Cluster3.png'],
    ['DEA_volcano_Cluster2_vs_Cluster3.png', 'DEA_heatmap_Cluster2_vs_Cluster3.png']
]
merged = merge_images_grid(image_grid, 'DEA_volcano_heatmap.png')
